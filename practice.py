...
def without_duplicates(words):
    ...
    uniquewords = {}
    for word in words:
        uniquewords.setdefault(word, None)
    return sorted(uniquewords.keys())
...
def get_sum_zero_pairs(numbers):
    ...
    return list(sum_zero_pairs.keys())
    ...
    for num in numbers:
        if -num in numbers:
            sum_zero_pairs.setdefault(abs(num), None)

    return [[-num, num] for num in sum_zero_pairs.keys()]
    # for num in sum_zero_pairs.keys():
    #     pairs_list.append([-num, num])
    #return sorted(pairs_list)

#get_sum_zero_pairs([1, 2, -1, 4, -2, 2, -2])
